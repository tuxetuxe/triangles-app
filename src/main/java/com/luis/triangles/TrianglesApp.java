...
public class TrianglesApp {
    ...
    private TriangleClassificationService triangleClassificationService = new TriangleClassificationService();

    public static void main(String[] args) throws Exception {
        new TrianglesApp().execute(args);
    }
    ...
    private void executeCommand(List<BigDecimal> sides) {
        ...
        if (triangle.isAPossibleTriangle()) {
            TriangleType type = triangleClassificationService.classifyBySideLength(triangle);
